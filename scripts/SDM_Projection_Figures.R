...
#1
png("Campanula_Projection_Big.png", width = 10, height = 15, units = "in", res = 300)
...
mtext("Campanula rotundifolia projection", side = 3, line = 6, cex = 2, font = 2)

#2
png("Delphinium_Projection_Big.png", width = 10, height = 15, units = "in", res = 300)
...
mtext("Delphinium occidentale projection", side = 3, line = 6, cex = 2, font = 2)
dev.off()