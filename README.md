...
Get and Clean Species Occurrence Data and Environmental Data
  Run the “./R/preprocessing/downloadDataForTAs.R” script
...
Run BioMOD Pipeline
  Run the “./R/modeling/biomodPipelineForTAs.R” script
...
Run Analysis and Save results
  Run the “./R/modeling/LMMandEMTrends.R” script
  Results will be located in the following folders:
    “./output/EMTrendsResults”
    “./output/LMMResults”
    “./output/R2BetaResults”

Create Analysis Tables
  Run the “./R/analysis/PlottingResults.R” script
  Charts can be looked at within the RStudio window

Generate Figure 2
  Run “./R/analysis/Generate_Fig_2.R”.
  View the figures for both species in “./output/Fig2”.
