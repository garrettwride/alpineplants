...
if (!dir.exists("./output/Fig3")) {
  dir.create("./output/Fig3")
}
...
png("./output/Fig3/NicheVsSchoener.png", width = 15, height = 4, units = "in", res = 300)

S_Plot <- grid.arrange(schoeners_algorithm_plot, 
...
# 
# png("./output/Fig3/NicheVsMeanSuitability.png", width = 10, height = 3, units = "in", res = 300)
#
# MS_Plot <- grid.arrange(meanSuit_algorithm_plot, 
...
# 
# png("./output/Fig3/NicheVsSuitableArea.png", width = 10, height = 3, units = "in", res = 300)
#
# SA_Plot <- grid.arrange(suitArea_algorithm_plot, 
...
# 
# png("./output/Fig3/NicheVsElevationCentroid.png", width = 10, height = 3, units = "in", res = 300)
#
# EC_Plot <- grid.arrange(elevCentroid_algorithm_plot, 
...
# 
# png("./output/Fig3/NicheVsTSS.png", width = 10, height = 3, units = "in", res = 300)
#
# TSS_Plot <- grid.arrange(tss_algorithm_plot, 
#              tss_paStrategy_plot, 
#              tss_paNumber_plot,
#              ncol = 3, nrow = 1)
# 
